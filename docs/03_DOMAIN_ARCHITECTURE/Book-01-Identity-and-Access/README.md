# Identity and Access Domain Architecture

## Domain Purpose

Manage users, authentication, authorization, roles, permissions, sessions, account lifecycle, and access audit trails.
...
| --- | --- |
| Core entities | User, Role, Permission, Policy, Session, Audit Event. |
| Primary workflows | authentication, authorization, account lifecycle, role assignment, permission review. |
