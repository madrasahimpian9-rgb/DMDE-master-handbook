# Academic Structure Domain Architecture

## Domain Purpose

Define academic years, terms, levels, programs, subjects, schedules, calendars, and academic operating structures.
...
| --- | --- |
| Core entities | Academic Year, Term, Level, Program, Subject, Schedule. |
| Primary workflows | academic year setup, subject catalog management, schedule planning, calendar maintenance. |
