# Student Management Domain Architecture

## Domain Purpose

Maintain student profiles, enrollment, lifecycle status, guardians, class placement, and student record history.
...
| --- | --- |
| Core entities | Student, Enrollment, Guardian, Student Status, Class Placement. |
| Primary workflows | student enrollment, transfer, status update, profile maintenance, guardian linking. |
