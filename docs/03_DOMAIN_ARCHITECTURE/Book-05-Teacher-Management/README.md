# Teacher Management Domain Architecture

## Domain Purpose

Maintain teacher profiles, assignments, workload, availability, competency mapping, and teaching responsibilities.
...
| --- | --- |
| Core entities | Teacher, Assignment, Workload, Availability, Competency. |
| Primary workflows | teacher onboarding, assignment planning, workload review, availability updates. |
