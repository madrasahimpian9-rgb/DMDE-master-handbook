# Curriculum Domain Architecture

## Domain Purpose

Manage curriculum structures, competencies, learning outcomes, subject mapping, and curriculum versioning.
...
| --- | --- |
| Core entities | Curriculum, Competency, Learning Outcome, Curriculum Map, Version. |
| Primary workflows | curriculum planning, competency mapping, curriculum approval, version change. |
