...
Support assessment setup, grading rules, score capture, feedback, moderation, progress review, and result publication.
...
| --- | --- |
| Core entities | Assessment, Rubric, Grade, Score, Feedback, Result. |
| Primary workflows | assessment planning, score entry, grading review, result publication. |
