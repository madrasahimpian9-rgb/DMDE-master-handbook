# Website CMS Domain Architecture

## Domain Purpose

Manage public website content, pages, announcements, media, navigation, approvals, and publication workflows.
...
| --- | --- |
| Core entities | Page, Content Block, Media Asset, Menu, Publication. |
| Primary workflows | content drafting, approval, publication, media management, page update. |
