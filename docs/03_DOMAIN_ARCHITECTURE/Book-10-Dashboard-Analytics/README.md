# Dashboard Analytics Domain Architecture

## Domain Purpose

Provide operational dashboards, analytics views, metrics, scorecards, filters, exports, and insight workflows.
...
| --- | --- |
| Core entities | Metric, Dashboard, Widget, Dataset, Filter, Export. |
| Primary workflows | dashboard review, metric definition, report filtering, export generation. |
