...
Manage notification templates, recipients, channels, delivery rules, status tracking, and communication audit trails.
...
| --- | --- |
| Core entities | Notification, Template, Recipient, Channel, Delivery Status. |
| Primary workflows | announcement delivery, event notification, delivery retry, template management. |
