# Document Management Domain Architecture

## Domain Purpose

Manage templates, generated documents, storage references, approvals, signatures, retention, and document audit history.
...
| --- | --- |
| Core entities | Document, Template, Approval, Storage Reference, Retention Policy. |
| Primary workflows | document generation, approval routing, archival, template update. |
