# Public Portal Domain Architecture

## Domain Purpose

Provide public-facing access to approved information, announcements, forms, search, and stakeholder-facing resources.
...
| --- | --- |
| Core entities | Portal Page, Public Content, Form, Search Index, Inquiry. |
| Primary workflows | public information access, form submission, announcement viewing, inquiry handling. |
