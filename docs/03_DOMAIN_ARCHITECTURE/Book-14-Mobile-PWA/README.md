# Mobile PWA Domain Architecture

## Domain Purpose

Provide mobile-friendly and progressive web access to core DMDE workflows, notifications, offline-tolerant views, and quick actions.
...
| --- | --- |
| Core entities | PWA Shell, Offline Cache, Push Subscription, Mobile Session, Quick Action. |
| Primary workflows | mobile login, notification access, offline read, quick workflow completion. |
