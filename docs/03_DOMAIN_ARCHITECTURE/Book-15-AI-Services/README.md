...
Provide governed AI-assisted capabilities for summarization, recommendations, content support, analytics assistance, and productivity workflows.
...
| --- | --- |
| Core entities | AI Request, Prompt, Model, Evaluation, Human Review, AI Output. |
| Primary workflows | AI assistance request, output review, prompt management, evaluation tracking. |
