...
Manage operational reports, formal exports, reporting definitions, schedules, data lineage, and compliance evidence.
...
| --- | --- |
| Core entities | Report, Export, Schedule, Definition, Lineage, Evidence. |
| Primary workflows | report generation, scheduled export, definition approval, reconciliation. |
